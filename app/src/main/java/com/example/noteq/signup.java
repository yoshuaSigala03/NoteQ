        ...
        msignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mail.isEmpty() || password.isEmpty()) {
                    ...
                    Toast.makeText(getApplicationContext(), "Password Harus 7 Digit Lebih", Toast.LENGTH_SHORT).show();
                } else

                {
                    /// registerasi user ke firebase firestore
        ...
        if(firebaseUser!=null)
        {
            firebaseUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    Toast.makeText(getApplicationContext(),"Email Verifikasi Terkirim",Toast.LENGTH_SHORT).show();
